...
export const demoIngestion: IngestionResponse = {
  ...
  document: {
    id: "doc-demo-001",
    kind: "receipt",
    original_name: "berrechid-oil-sugar-receipt.jpg",
    ...
    lines: [
      {
        ...
        product_id: "cooking-oil-1l",
        product_name: "Cooking oil 1L",
        original_product_name: "Huile 1L",
        unit: "bottle",
        quantity: 20,
        unit_price_centimes: 2_200,
        line_total_centimes: 44_000,
      ...
      },
      {
        ...
        product_id: "sugar-1kg",
        product_name: "Sugar 1kg",
        original_product_name: "Sukkar 1kg",
        unit: "bag",
        quantity: 10,
        unit_price_centimes: 850,
        line_total_centimes: 8_500,
  ...
  tool_calls: [
    {
      ...
      duration_ms: 420,
      fallback_used: false,
      input_summary: "Receipt image and Darija/French voice note",
      output_summary: "Detected one purchase, one expense and two products",
    },
    {
      ...
      duration_ms: 610,
      fallback_used: false,
      input_summary: "Validated extraction with product normalization",
      output_summary: "Draft created; sugar quantity marked uncertain",
    },
    {
      ...
      duration_ms: 812,
      fallback_used: false,
      input_summary: "Confirmed stock and seven days of sales",
      output_summary: "Cooking oil may run out in 4 days",
    },
  ],
};
