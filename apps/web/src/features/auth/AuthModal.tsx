...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleDemoLogin = async (role: "merchant" | "supplier") => {
    ...
    try {
      ...
      setSuccessMsg(`Signed in as ${role === "merchant" ? "Demo Merchant" : "Demo Supplier"}!`);
      setTimeout(() => {
        onClose();
      }, 800);
    } catch {
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4 text-xs">
          {isSignUp && (
            <>
              ...
              <div>
                <label className="block font-medium text-slate-300 mb-1">Business / Store Name</label>
                <input
                  type="text"
                  required
                  value={orgName}
              ...
              <div>
                <label className="block font-medium text-slate-300 mb-1.5">Business Role & Type</label>
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-400 font-normal">Local Shop / Grocery</div>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-slate-400 font-normal">Wholesaler / Distributor</div>
                    </div>
                  </button>
                </div>
              </div>
          ...
          >
            {loading ? "Processing..." : isSignUp ? "Create Account & Continue" : "Sign In to Portal"}
          </button>
        </form>
