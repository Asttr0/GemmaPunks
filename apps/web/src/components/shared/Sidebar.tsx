...
const navItems: NavItem[] = [
  { path: "/", label: "Dashboard", icon: <LayoutDashboard className="size-5" /> },
  { path: "/catalog", label: "Catalog", icon: <Package className="size-5" /> },
  { path: "/orders", label: "Orders", icon: <ShoppingCart className="size-5" /> },
  { path: "/customers", label: "Customers", icon: <Users className="size-5" /> },
  { path: "/analytics", label: "Analytics", icon: <BarChart3 className="size-5" /> },
  { path: "/settings", label: "Settings", icon: <Settings className="size-5" /> },
];

export function Sidebar({ portalAccent = "merchant", orgName = "Organization" }: SidebarProps) {
